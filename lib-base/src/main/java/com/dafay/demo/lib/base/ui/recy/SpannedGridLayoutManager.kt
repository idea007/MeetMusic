...
open class SpannedGridLayoutManager(val orientation: Orientation,
    ...
    override fun onMeasure(
        ...
        debug("onMeasure widthSpec width:$width height:$height widthMode:$widthMode heightMode:$heightMode")
    }
    ...
    override fun onLayoutChildren(recycler: RecyclerView.Recycler, state: RecyclerView.State) {
        ...
        debug("onLayoutChildren remainSpace: $remainSpace state.itemCount:${state.itemCount}")
        ...
        debug("scroll:$scroll size:$size layoutEnd:$layoutEnd getPaddingEndForOrientation():${getPaddingEndForOrientation()} overScroll:$overScroll")
...
//                delta > 0
        ...
        val canScrollForward =
                (scroll + size) < (layoutEnd + rectsHelper.itemSize + getPaddingEndForOrientation())
        delta > 0
        debug("scrollBy firstVisiblePosition:$firstVisiblePosition childCount:$childCount state.itemCount:${state.itemCount} scroll:$scroll size:$size layoutEnd:$layoutEnd  rectsHelper.itemSize:${rectsHelper.itemSize} getPaddingEndForOrientation():${getPaddingEndForOrientation()} canScrollBackwards:$canScrollBackwards canScrollForward:$canScrollForward")
    ...
    protected open fun scrollBy(distance: Int, state: RecyclerView.State): Int {
        ...
        debug("scrollBy distance:$distance correctedDistance:$correctedDistance scroll:$scroll")
        return correctedDistance
    }
